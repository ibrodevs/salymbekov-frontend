   ...
   const cards = [
      {
         ...
         description: 'Список необходимых документов для поступления',
         icon: FiFileText,
      ...
      {
         id: 2,
         title: 'Положение приема',
         description: 'Правила и условия приема в университет',
         icon: FiClipboard,
      ...
      {
         id: 3,
         title: 'График отбора и зачисления й',
         description: 'График приемной кампании',
         icon: FiCalendar,
      ...
      <div className="w-full relative min-h-screen bg-gradient-to-br from-gray-50 to-blue-50">
         ...
         >
            ...
            <div className="relative z-10 container mx-auto px-4 text-center text-white">
               ...
               >
                  Информация о процедуре поступления
               </motion.p>
            </div>
         </motion.div>
