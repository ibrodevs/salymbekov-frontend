  ...
  const sections = [
    {
      ...
      items: [
        {
          subtitle: '1.1. Основание разработки',
          points: [
            'Настоящее Положение разработано в соответствии с Законом Кыргызской Республики «Об образовании»; Положением о порядке перевода, отчисления и восстановления студентов высших учебных заведений, утвержденного Постановлением Правительства Кыргызской Республики от 29 мая 2012 года №346, Уставом Учреждения и другими нормативными правовыми актами, регулирующими деятельность образовательных организаций высшего профессионального образования.',
          ]
        },
        {
          subtitle: '1.2. Область применения',
          points: [
        ...
        {
          subtitle: '1.3. Условия перевода и восстановления',
          points: [
            'Определяющим условием перевода и восстановления студентов в КГУ является их подготовленность к освоению конкретной (выбранной) основной образовательной программы профессионального образования, предшествующая академическая успеваемость, а также наличие вакантных мест.',
          ]
        },
        {
          subtitle: '1.4. Продолжительность обучения',
          points: [
            'Общая продолжительность обучения студента не должна превышать срока, установленного учебным планом Университета для освоения основной образовательной программы.',
          ]
        }
      ]
    },
    {
      title: '2. Порядок перевода студентов',
      items: [
        {
          subtitle: '2.1. Общие условия перевода',
          points: [
            'Перевод студентов высших учебных заведений, имеющих государственную аккредитацию (аттестацию), осуществляется в период летних или зимних каникул, только с согласия руководителей обоих вузов, при наличии вакантных мест на соответствующем курсе по интересующей студента специальности/направлении, на договорной основе с полной компенсацией затрат за обучение.',
            'Студенты, которые переводятся из других образовательных организаций (учреждений) или с одной специальности на другую, а также восстанавливаются в число студентов после отчисления, плату за ликвидацию разницы в учебных планах вносят дополнительно. Размер данной оплаты определяется расчетным путем в зависимости от разницы в учебной нагрузке и размера ставок часовой оплаты труда преподавателей.',
          ]
        },
        {
          subtitle: '2.2. Ограничения по переводу',
          points: [
            'Ограничении, связанных с курсом и формой обучения, видом основной образовательной программы, на которые происходит перевод студента, Университет не устанавливает.',
          ]
        },
        {
          subtitle: '2.3. Права студентов на перевод',
          points: [
            'Студенты, успешно завершившие первый год обучения, имеют право на перевод в другую образовательную программу внутри Университета, на аналогичную или другую образовательную программу из другого вуза в Университет, при условии соответствия требованиям приема на эту образовательную программу, наличия вакантных мест и согласия руководителей обеих программ (вузов). При переводе из другого вуза в Университет перезачету подлежат только те дисциплины, соответствующие профессиональному циклу основной образовательной программы Учреждения «Салымбеков Университет» на которую осуществляется перевод и по которым заявитель имеет удовлетворительную оценку и выше.',
          ]
        },
        {
          subtitle: '2.4. Перевод из неаккредитованных вузов',
          points: [
            'Перевод студентов, получающих образование в неаккредитованных (неаттестованных) высших учебных заведениях, в Университет на любую форму обучения может осуществляться после реализации Университетом права на аттестацию в форме экстерната, за исключением специальностей/направлений высшего профессионального образования, обучение на которых в форме экстерната не допускается.',
          ]
        },
        {
          subtitle: '2.5. Перевод при реорганизации',
          points: [
            'В случае реорганизации, ликвидации Университета перевод студентов обеспечивается ректором, в ведении которого находится Университет, совместно с Министерством образования и науки Кыргызской Республики.',
          ]
        },
        {
          subtitle: '2.6. Ограничения по курсам',
          points: [
            'Перевод студентов на первом и последнем курсе обучения не осуществляется.',
          ]
        },
        {
          subtitle: '2.7. Перевод с грантов',
          points: [
            'Перевод студентов, обучающихся на платной основе по грантам не осуществляется.',
          ]
        },
        {
          subtitle: '2.8. Порядок подачи заявления',
          points: [
            'Перевод студента в Учреждение «Салымбеков Университет» для продолжения образования, в том числе сопровождающийся переходом с одной основной образовательной программы специальности/направления на другую, по всем формам обучения, а также с их сменой осуществляется по личному заявлению студента. Заявление направляется ректору для принятия решения о допуске студента к аттестации. К заявлению прилагается ксерокопия зачетной книжки (впоследствии сверяется с академической справкой), прилагается транскрипт (оценочный лист).',
          ]
        },
        {
          subtitle: '2.9. Аттестационная комиссия',
          points: [
        ...
        {
          subtitle: '2.10. Протокол заседания',
          points: [
            'По результатам аттестации аттестационная комиссия готовит протокол заседания.',
          ]
        },
        {
          subtitle: '2.11. Индивидуальный учебный план',
          points: [
            'В случае, когда невозможно перезачесть отдельные дисциплины или имеется наличие неизученных дисциплин (разделов дисциплин), Университет разрабатывает и утверждает индивидуальный учебный план студента, который предусматривает перечень дисциплин (или их разделов), подлежащих изучению, их объемы и установленные сроки сдачи экзаменов/зачетов. Перечень дисциплин, подлежащих сдаче (ликвидации академической разницы) не должен превышать 7 (семи) дисциплин. Академическая разница должна быть ликвидирована в пределах данного академического года.',
          ]
        },
        {
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    Настоящее Положение регулирует порядок перевода, отчисления и восстановления студентов в Учреждении «Салымбеков Университет». Нажмите на раздел для просмотра подробной информации.
                  </p>
                </div>
              </div>
            </motion.div>
