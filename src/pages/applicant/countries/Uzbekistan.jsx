      ...
      <div className="relative z-10 py-8 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <h1 className="text-4xl font-bold text-gray-800 mb-2">Узбекистан</h1>
          ...
          >
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              Салымбеков Университет активно сотрудничает с партнерами в Узбекистане для обеспечения качественного образования студентов из Республики Узбекистан.
            </p>
            <p className="text-gray-600">
              Подробная информация о представительстве в Узбекистане будет добавлена в ближайшее время.
            </p>
          </motion.div>
          ...
          >
            <div className="bg-white rounded-xl p-6 shadow-lg text-center hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600">Ташкент</p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg text-center hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600">36 млн человек</p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg text-center hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600">448,978 км²</p>
            </div>
          </motion.div>
