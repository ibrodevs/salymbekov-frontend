...
import photo1 from '../../../assets/science/management/c0b4333-300x200.jpg';
import photo2 from '../../../assets/science/management/c0b4388-300x200.jpg';
import photo3 from '../../../assets/science/management/c0b7310-300x200.jpg';
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gray-600 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-4xl font-bold">Лаборатория химии</h1>
        </div>
      </div>
          ...
          <aside className="md:w-64 flex-shrink-0">
            <div className="bg-white rounded-lg shadow-md overflow-hidden sticky top-4">
              <nav>
                ...
                <Link to="/science/labs/chemistry" className="block px-4 py-3 border-b border-gray-200 bg-blue-50 text-blue-600 font-semibold">
                  ЛАБОРАТОРИЯ ХИМИИ
                </Link>
          ...
          <main className="flex-1">
            <div className="bg-white rounded-lg shadow-md p-8 mb-8">
              <p className="text-gray-700 text-lg leading-relaxed mb-6">
                Лаборатория химии предназначена для проведения практических занятий по общей, неорганической и органической химии. Оснащена необходимым оборудованием и реактивами.
              </p>

              {/* Photo Gallery */}
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                <img src={photo1} alt="Лаборатория химии" className="rounded-lg w-full h-auto" />
                <img src={photo2} alt="Лаборатория химии" className="rounded-lg w-full h-auto" />
                <img src={photo3} alt="Лаборатория химии" className="rounded-lg w-full h-auto" />
              </div>
            </div>
          </main>
        </div>
