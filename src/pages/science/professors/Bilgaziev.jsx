    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gray-600 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-4xl font-bold">Эмиль Билгазиев</h1>
        </div>
      </div>
          ...
          <aside className="md:w-64 flex-shrink-0">
            <div className="bg-white rounded-lg shadow-md overflow-hidden sticky top-4">
              <nav>
                ...
                <Link to="/science/professors/bilgaziev" className="block px-4 py-3 border-b border-gray-200 bg-blue-50 text-blue-600 font-semibold">
                  ЭМИЛЬ БИЛГАЗИЕВ
                </Link>
            ...
            <div className="bg-white rounded-lg shadow-md p-8">
              <div className="flex flex-col md:flex-row gap-6 items-start">
                ...
                <div className="flex-1">
                  <h2 className="text-2xl font-bold text-gray-900 mb-4">Эмиль Билгазиев</h2>
