        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <h1 className="text-5xl font-bold mb-4">
              Доктор Данияр Осмонов
            </h1>
            <p className="text-xl text-white/90 max-w-3xl">
              Эксперт и тренер мирового уровня по фаллопротезированию, заведующий отделением андрологии в клинике Киль, Германия
            </p>
          </motion.div>
        </div>
      </div>
            ...
            >
              <div className="flex flex-col lg:flex-row gap-8 items-start">
                ...
                >
                  ...
                  <div className="mt-6 space-y-4">
                    ...
                    >
                      ...
                      <p className="text-gray-700 text-sm mt-2">Заведующий отделением андрологии</p>
                    </motion.div>
                    ...
                    >
                      <div className="flex items-center">
                        <FaHospital className="text-[#023E8A] mr-3" />
                        <span className="font-semibold text-gray-900">Место работы</span>
                      </div>
                      <p className="text-gray-700 text-sm mt-2">Клиника Киль, Германия</p>
                    </motion.div>
                    ...
                    >
                      ...
                      <p className="text-gray-700 text-sm mt-2">Андрология, фаллопротезирование</p>
                    </motion.div>
                  </div>
                </motion.div>
                ...
                <div className="flex-1">
                  ...
                  >
                    <h2 className="text-3xl font-bold text-gray-900 mb-6">Доктор Данияр Осмонов</h2>
                    
                    {/* Description */}
                    <div className="prose prose-lg max-w-none text-gray-700 mb-8">
                      <p className="text-lg leading-relaxed mb-6">
                        Выдающийся специалист в области андрологии, признанный эксперт и тренер мирового уровня по фаллопротезированию. 
                        Доктор Осмонов возглавляет отделение андрологии в престижной клинике города Киль в Германии.
                      </p>
                      <p className="text-lg leading-relaxed">
                        Его профессиональная деятельность сочетает клиническую практику, научные исследования и обучение 
                        молодых специалистов в области мужского здоровья и репродуктивной медицины.
                      </p>
                    </div>
                        ...
                        {[
                          {
                            ...
                            description: "Проведение сложных операций по фаллопротезированию и лечение заболеваний мужской репродуктивной системы"
                          },
                          {
                            title: "Научные исследования",
                            description: "Исследования в области андрологии, разработка новых методов диагностики и лечения"
                          },
                          {
                            title: "Обучение специалистов",
                            description: "Проведение мастер-классов и тренингов для врачей со всего мира"
                          },
                          {
                            title: "Международное сотрудничество",
                            description: "Участие в международных конференциях и научных проектах"
                          }
                        ].map((item, index) => (
                          <motion.div
                            key={index}
                    ...
                    >
                      <h4 className="text-xl font-bold text-gray-900 mb-4 flex items-center">
                        ...
                        Специализация в андрологии
                      </h4>
                      <div className="grid md:grid-cols-2 gap-6">
                        {[
                          {
                            area: "Фаллопротезирование",
                            details: "Хирургическое восстановление эректильной функции с использованием современных протезов"
                          },
                          {
                            area: "Мужское бесплодие",
                            details: "Диагностика и лечение нарушений репродуктивной функции у мужчин"
                          },
                          {
                            area: "Андрогенный дефицит",
                            details: "Коррекция возрастного и патологического дефицита тестостерона"
                          },
                          {
                            area: "Урологическая хирургия",
                            details: "Оперативное лечение заболеваний мужской мочеполовой системы"
                          }
                        ].map((specialty, index) => (
                          <motion.div
                            key={index}
                          ...
                          >
                            ...
                            <p className="text-gray-700 text-sm">{specialty.details}</p>
                          </motion.div>
                        ))}
                      </div>
                    </motion.div>
                    ...
                    >
                      ...
                      <div className="space-y-3">
                        {[
                          "Эксперт мирового уровня в области фаллопротезирования",
                          "Тренер для врачей из разных стран по современным методикам андрологии",
                          "Участник международных конгрессов и симпозиумов по урологии и андрологии",
                          "Автор научных публикаций в международных медицинских журналах",
                          "Член профессиональных ассоциаций урологов и андрологов"
                    ...
                    >
                      ...
                      <div className="grid md:grid-cols-2 gap-6">
                        <div>
                          <h5 className="font-semibold text-gray-900 mb-3">Образование</h5>
                          <ul className="space-y-2 text-gray-700">
                            ...
                            <li className="flex items-center">
                              <div className="w-2 h-2 bg-[#023E8A] rounded-full mr-3"></div>
                              Специализация в урологии и андрологии
                            </li>
                            <li className="flex items-center">
                              <div className="w-2 h-2 bg-[#023E8A] rounded-full mr-3"></div>
                        ...
                        <div>
                          <h5 className="font-semibold text-gray-900 mb-3">Научные интересы</h5>
                          <ul className="space-y-2 text-gray-700">
                            <li className="flex items-center">
                              <div className="w-2 h-2 bg-[#023E8A] rounded-full mr-3"></div>
                              Инновации в фаллопротезировании
                            </li>
                            <li className="flex items-center">
                              <div className="w-2 h-2 bg-[#023E8A] rounded-full mr-3"></div>
