...
import { FaArrowLeft, FaUserGraduate, FaGraduationCap, FaGlobeAmericas, FaBook, FaAward } from 'react-icons/fa';
      ...
      <div className="relative bg-gradient-to-br from-[#023E8A] via-[#0077B6] to-[#023E8A] text-white py-24 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <h1 className="text-5xl font-bold mb-4">Ольга Потапова</h1>
            <p className="text-xl text-white/90 max-w-3xl">Эксперт в трансляционной онкологии и диагностике</p>
          </motion.div>
        </div>
      </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden sticky top-4 border border-gray-100">
              ...
              <nav className="p-2">
                {professorSections.map((s) => {
                  const Icon = s.icon;
                  const active = s.path === '/science/professors/potapova';
                  return (
              ...
              <div className="flex flex-col lg:flex-row gap-8 items-start">
                ...
                >
                  <div className="bg-gradient-to-br from-gray-100 to-gray-200 rounded-2xl overflow-hidden shadow-lg">
                    <img src={potapovaPhoto} alt="Ольга Потапова" className="w-full h-auto object-cover" />
                  </div>
                  <div className="mt-6 space-y-4">
                    <motion.div whileHover={{ scale: 1.02 }} className="bg-blue-50 p-4 rounded-xl border border-blue-200">
                      ...
                      <p className="text-gray-700 text-sm mt-2">Исследователь, руководитель проектов</p>
                    </motion.div>
                    <motion.div whileHover={{ scale: 1.02 }} className="bg-green-50 p-4 rounded-xl border border-green-200">
                      <div className="flex items-center">
                        ...
                        <span className="font-semibold text-gray-900">Международные проекты</span>
                      </div>
                      <p className="text-gray-700 text-sm mt-2">Координация крупных исследований</p>
                    </motion.div>
                  </div>
                </motion.div>
                <div className="flex-1">
                  <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.2 }}>
                    <h2 className="text-3xl font-bold text-gray-900 mb-6">Ольга Потапова</h2>
                    <div className="prose prose-lg max-w-none text-gray-700 mb-8">
                      <p className="text-lg leading-relaxed mb-6">
                        Обширный опыт в разработке таргетной терапии и диагностических тестов, участие в международных программах по онкологии.
                      </p>
                    </div>
                    <motion.div
                      initial={{ opacity: 0, y: 20 }}
                    ...
                    >
                      ...
                      <div className="space-y-3">
                        {[
                          ...
                          'Международные курсы по диагностике'
                        ].map((item, i) => (
                          <motion.div
                            key={i}
                            initial={{ opacity: 0, x: -20 }}
                    ...
                    >
                      ...
                      <div className="space-y-3">
                        {['Таргетная терапия', 'Закупка биообразцов', 'Доклинические исследования'].map((item, i) => (
                          <motion.div
                            key={i}
                            initial={{ opacity: 0, x: -20 }}
                            whileInView={{ opacity: 1, x: 0 }}
                    ...
                    >
                      ...
                      <div className="space-y-3">
                        {['Работа в международных консорциумах', 'Главный исследователь программ', 'Вклад в развитие диагностики'].map((item, i) => (
                          <motion.div
                            key={i}
                            initial={{ opacity: 0, x: -20 }}
                            whileInView={{ opacity: 1, x: 0 }}
