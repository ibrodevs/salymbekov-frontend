    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="relative h-[300px] bg-gradient-to-r from-blue-900 to-blue-700">
        ...
        <div className="relative container mx-auto px-4 h-full flex items-center">
          <div className="text-white">
            ...
            <h1 className="text-5xl font-bold mb-4">Гранты</h1>
            <p className="text-xl text-gray-200">
              Информация о грантах и финансировании
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-md p-12 text-center">
          ...
          <h2 className="text-3xl font-bold text-gray-800 mb-4">Гранты</h2>
          <p className="text-gray-600 text-lg">
            Раздел находится в разработке. Информация о грантах будет добавлена в ближайшее время.
          </p>
        </div>
      </div>
    </div>
