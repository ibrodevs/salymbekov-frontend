...
import { 
  ...
  FaHeart, FaComments, FaHeadset, FaUserShield 
} from 'react-icons/fa';
...
const PsychologicalSupport = () => {
  ...
  const opportunitiesSections = [
    { 
      ...
      name: t('psychologicalSupport.sections.medical'), 
      icon: FaHospital,
    },
    { 
      path: "/student/opportunities/dorm", 
      name: t('psychologicalSupport.sections.dorm'), 
      icon: FaBed,
    },
    { 
      path: "/student/opportunities/social", 
      name: t('psychologicalSupport.sections.social'), 
      icon: FaHandHoldingHeart,
    },
    { 
      path: "/student/opportunities/courses", 
      name: t('psychologicalSupport.sections.courses'), 
      icon: FaBookOpen,
    },
    { 
      path: "/student/opportunities/mobility", 
      name: t('psychologicalSupport.sections.mobility'), 
      icon: FaGlobe,
    },
    { 
      path: "/student/opportunities/psychology", 
      name: t('psychologicalSupport.sections.psychology'), 
      icon: FaBrain,
      active: true,
    },
    { 
      path: "/student/opportunities/service-center", 
      name: t('psychologicalSupport.sections.serviceCenter'), 
      icon: FaUsersCog,
    },
    { 
      path: "/student/opportunities/adaptation", 
      name: t('psychologicalSupport.sections.adaptation'), 
      icon: FaUserGraduate,
    },
  ];
      ...
      <div className="relative bg-gradient-to-br from-[#023E8A] via-[#0077B6] to-[#023E8A] text-white py-24 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            {t('psychologicalSupport.backToStudent')}
          </motion.button>
          ...
          >
            <div className="inline-block px-4 py-2 bg-white/10 backdrop-blur-sm rounded-full mb-4">
              <span className="text-white/90 text-sm font-medium">
                {t('psychologicalSupport.category')}
              </span>
            </div>
            <h1 className="text-5xl font-bold mb-4">
              {t('psychologicalSupport.title')}
            </h1>
            <p className="text-xl text-white/90 max-w-3xl">
              {t('psychologicalSupport.subtitle')}
            </p>
          </motion.div>
        </div>
      </div>
        ...
        <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden sticky top-4 border border-gray-100">
              <div className="bg-gradient-to-r from-[#023E8A] to-[#0077B6] text-white px-6 py-4">
                <div className="flex items-center">
                  ...
                  <h3 className="font-bold text-lg">{t('psychologicalSupport.sidebarTitle')}</h3>
                </div>
              </div>
              <nav className="p-2">
          ...
          <main className="flex-1">
            ...
            >
              ...
              >
                <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-6 border border-blue-200 mb-8">
                  <h2 className="text-3xl font-bold text-gray-900 mb-4 flex items-center">
                    ...
                    {t('psychologicalSupport.mainTitle')}
                  </h2>
                  <p className="text-lg text-gray-700 leading-relaxed mb-4">
                    {t('psychologicalSupport.mainDescription')}
                  </p>
                  <p className="text-lg text-gray-700 leading-relaxed mb-4">
                    {t('psychologicalSupport.secondaryDescription')}
                  </p>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
                    {t('psychologicalSupport.features', { returnObjects: true }).map((feature, index) => {
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-6">
                  {t('psychologicalSupport.supportAreas')}
                </h3>
                <motion.div 
                  className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6"
                  variants={containerVariants}
                >
                  {t('psychologicalSupport.supportCategories', { returnObjects: true }).map((area, index) => {
              ...
              >
                <h3 className="text-2xl font-bold text-gray-900 mb-6">
                  {t('psychologicalSupport.specialists')}
                </h3>
                
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  {t('psychologicalSupport.specialistsList', { returnObjects: true }).map((specialist, index) => (
                    <motion.div
                      key={index}
                    ...
                    >
                      <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
                        <motion.div 
                          className="w-32 h-32 rounded-2xl overflow-hidden flex-shrink-0"
                          whileHover={{ scale: 1.05 }}
                          transition={{ duration: 0.3 }}
                        >
                          <img src={specialist.photo === 'img52' ? img52 : img53} alt={specialist.name} className="w-full h-full object-cover" />
                        </motion.div>
                        <div className="flex-1 text-center md:text-left">
                          ...
                          <div className="flex flex-wrap gap-2 justify-center md:justify-start">
                            {specialist.badges.map((badge, badgeIndex) => (
                              <motion.span
                                key={badgeIndex}
                                ...
                                className="px-3 py-1 bg-white/80 rounded-full text-sm text-gray-700 border border-purple-300 hover:bg-white hover:shadow-sm transition-all"
                              >
                                {badge}
                              </motion.span>
                            ))}
              ...
              >
                <div className="bg-gradient-to-r from-yellow-50 to-amber-50 rounded-2xl p-6 border border-yellow-200">
                  <h3 className="text-2xl font-bold text-gray-900 mb-6">
                    {t('psychologicalSupport.processTitle')}
                  </h3>
                  
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {t('psychologicalSupport.processSteps', { returnObjects: true }).map((step, index) => (
                      <motion.div
                        key={index}
              ...
              >
                <h3 className="text-xl font-bold text-gray-900 mb-4 flex items-center">
                  ...
                  {t('psychologicalSupport.additionalInfo.title')}
                </h3>
                <p className="text-gray-700 mb-6">
                  {t('psychologicalSupport.additionalInfo.description')}
                </p>
                <div className="flex flex-wrap gap-4">
                  ...
                  >
                    ...
                    {t('psychologicalSupport.additionalInfo.adaptationButton')}
                  </motion.a>
                  <motion.button
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                  ...
                  >
                    ...
                    {t('psychologicalSupport.additionalInfo.consultationButton')}
                  </motion.button>
                </div>
              </motion.div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="text-lg font-semibold text-gray-900 mb-2">
                      {t('psychologicalSupport.contact.title')}
                    </h4>
                    <p className="text-gray-700 mb-3">
                      {t('psychologicalSupport.contact.description')}
                    </p>
                    <div className="flex flex-wrap gap-2">
                      {[
                        t('psychologicalSupport.contact.phone'),
                        t('psychologicalSupport.contact.email'),
                        t('psychologicalSupport.contact.location'),
                        t('psychologicalSupport.contact.hours')
                      ].map((contact, index) => (
                        <motion.span
                          key={index}
                          initial={{ opacity: 0, scale: 0.8 }}
