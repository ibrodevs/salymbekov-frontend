...
const ModuleSchedule = () => {
  ...
  const scheduleSections = [
    { 
      ...
      name: t('moduleSchedule.sections.study'), 
      icon: FaChartLine,
    },
    { 
      path: "/student/schedule/modules", 
      name: t('moduleSchedule.sections.modules'), 
      icon: FaCalendarCheck,
      active: true 
    },
    { 
      path: "/student/schedule/practice", 
      name: t('moduleSchedule.sections.practice'), 
      icon: FaUserGraduate,
    },
    { 
      path: "/student/schedule/mfm", 
      name: t('moduleSchedule.sections.mfm'), 
      icon: FaBook,
    },
    { 
      path: "/student/schedule/college", 
      name: t('moduleSchedule.sections.college'), 
      ...
      <div className="relative bg-gradient-to-br from-[#023E8A] via-[#0077B6] to-[#023E8A] text-white py-24">
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            {t('moduleSchedule.backToStudent')}
          </button>

          <div>
            <div className="inline-block px-4 py-2 bg-white/10 backdrop-blur-sm rounded-full mb-4">
              <span className="text-white/90 text-sm font-medium">
                {t('moduleSchedule.category')}
              </span>
            </div>
            <h1 className="text-5xl font-bold mb-4">
              {t('moduleSchedule.title')}
            </h1>
            <p className="text-xl text-white/90 max-w-3xl">
              {t('moduleSchedule.subtitle')}
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden sticky top-4 border border-gray-100">
              <div className="bg-gradient-to-r from-[#023E8A] to-[#0077B6] text-white px-6 py-4">
                <div className="flex items-center">
                  ...
                  <h3 className="font-bold text-lg">{t('moduleSchedule.sidebarTitle')}</h3>
                </div>
              </div>
              <nav className="p-2">
          ...
          <main className="flex-1">
            <div className="bg-white rounded-2xl shadow-lg p-8 mb-8 border border-gray-100 hover:shadow-xl transition-shadow">
              {/* Годы расписаний */}
              {t('moduleSchedule.scheduleData', { returnObjects: true }).map((yearData, index) => (
                <div key={index} className="mb-8 last:mb-0">
                  ...
                  <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-6 border border-blue-200 mb-6">
                    <h2 className="text-2xl font-bold text-gray-900 flex items-center">
                      ...
                      {yearData.year} {t('moduleSchedule.academicYear')}
                    </h2>
                  </div>
              ...
              <div className="mt-12 bg-gradient-to-r from-purple-50 to-pink-50 rounded-2xl p-6 border border-purple-200">
                <h3 className="text-xl font-bold text-gray-900 mb-4 flex items-center">
                  ...
                  {t('moduleSchedule.importantInfo.title')}
                </h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {t('moduleSchedule.importantInfo.items', { returnObjects: true }).map((item, index) => (
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="text-lg font-semibold text-gray-900 mb-2">
                      {t('moduleSchedule.notification.title')}
                    </h4>
                    <a
