    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative py-20">
        ...
        <div className="relative container mx-auto px-6 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-6 text-white">{t('internationalAccreditation.hero.title')}</h1>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-12">
            <p className="text-gray-700 text-lg leading-relaxed">
              {t('internationalAccreditation.description')}
            </p>
          </div>
          ...
          <div className="text-center">
            ...
            >
              {t('internationalAccreditation.certificateButton')}
            </button>
          </div>
        </div>
      </div>
      ...
      {showCertificate && (
        ...
        >
          <div className="relative max-w-4xl max-h-full">
            ...
            <img 
              src="https://salymbekov.com/wp-content/uploads/2023/04/2.international-accreditattion_page-0001.jpg" // Замените на реальный URL
              alt={t('internationalAccreditation.certificateAlt')}
...
export default InternationalAccreditation;