    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative py-20">
        ...
        <div className="relative container mx-auto px-6 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-6 text-white">{t('programAccreditation.hero.title')}</h1>
        </div>
      </section>
      ...
      {showCertificate && (
        ...
        >
          <div className="relative max-w-4xl max-h-full">
            ...
            <img 
              src="https://salymbekov.com/wp-content/uploads/2023/04/certificate-int.-program-accreditation_page-0001-e1682571823618.jpg" // Замените на реальный URL
